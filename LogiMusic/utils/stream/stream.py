...
import config
from LogiMusic import Carbon, YouTube, app
from LogiMusic.core.call import Logi
from LogiMusic.misc import db
from LogiMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from LogiMusic.utils.exceptions import AssistantErr
from LogiMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from LogiMusic.utils.inline.playlist import close_markup
from LogiMusic.utils.pastebin import Logibin
from LogiMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Logi.force_stop_stream(chat_id)
