...
from LogiMusic.utils.database import get_authuser_names, get_cmode
from LogiMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from LogiMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Logi.stop_stream(message.chat.id)
    except:
        pass
