...
from LogiMusic import Telegram, YouTube, app
from LogiMusic.misc import SUDOERS
from LogiMusic.plugins.play.playlist import del_plist_msg
from LogiMusic.plugins.sudo.sudoers import sudoers_list
from LogiMusic.utils.database import (add_served_chat,
                                       add_served_user,
                                       blacklisted_chats,
                                       get_assistant, get_lang,
                                       get_userss, is_on_off,
                                       is_served_private_chat)
from LogiMusic.utils.decorators.language import LanguageStart
from LogiMusic.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/{config.SUPPORT_GROUP}) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
